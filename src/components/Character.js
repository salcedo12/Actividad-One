...
//                             </Card.Body>
//                             <Link className="text-decoration-none border  bg-info rounded p-2 text-center text-white" to={`/characters/${character.id}`}><AiOutlineInfoCircle/> Info</Link>
//                         </Card>
//                         </Col>
//                     ))}
//                     </Row>
    ...
    <>
      ...
      <Container>
        <Form>
          ...
          <Container fluid> {/* Cambiado a fluid */}
            <Row>
              <Col
                className="border rounded border-info h-100 p-3"
                xs={12} md={4} lg={3} xl={2} // Ajusta los tamaños de las columnas
              >
                <h3>Filters</h3>
                <Form.Group>
                  <Form.Label>Status:</Form.Label>
                  ...
                  {characters.map((character) => (
                    <Col key={character.id} xs={12} sm={6} md={4} lg={3} xl={3}>
                      <Card className="my-3">
                        ...
                        <Card.Body>
                          ...
                          <Card.Text>
                            ...
                            {character.status === "Alive" ? (
                              ...
                              <span className="bg-danger text-white rounded p-1">
                                {character.status}
                              </span>
                            )}
                          </Card.Text>
                        ...
                        <Link
                          className="text-decoration-none border bg-info rounded p-2 text-center text-white"
